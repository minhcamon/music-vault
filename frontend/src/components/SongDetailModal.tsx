              ...
              <div className="w-full max-w-sm space-y-4 pt-1">
                ...
                <div className="flex items-center justify-center gap-6">
                  ...
                  <button
                    ...
                    className="w-14 h-14 rounded-full bg-accent-primary hover:bg-accent-primaryHover text-white flex items-center justify-center shadow-accent-glow hover:scale-105 transition-transform"
                  >
          ...
          <div className="w-full max-w-xl flex flex-col items-center justify-center space-y-8 text-center">
            ...
            <div className="w-full space-y-6 pt-2">
              ...
              <div className="flex items-center justify-center gap-8">
                ...
                <button
                  onClick={onTogglePlay}
                  className="w-16 h-16 rounded-full bg-accent-primary hover:bg-accent-primaryHover text-white flex items-center justify-center shadow-accent-glow hover:scale-105 transition-transform"
                >
